...
<g id="svg1_sl_wrap">
  <g id="me_after">
    ...
    <g id="leaf" v-bind:class="{ fadein: isFadeinLeaves, fadeout: isFadeoutLeaves }">
      <g id="leaf_left">
        <path class="cls-3" d="M231.67,866c-26.68,5.24-54.19-.22-80.75-6.08-21.44-4.72-43.47-10-61.26-22.86s-30.49-35.3-25.42-56.67c3.86-16.29,17.36-29,32.73-35.7,23-9.93,50-7.66,73,2.27s42.32,26.91,58.75,45.81c7.29,8.38,14.25,17.52,17,28.27s.5,23.49-8.19,30.41Z" transform="translate(2.51 -737.52)"/>
...
export default {
  ...
  methods: {
    ...
    infAnim(el, pathFrom, pathMid, pathTo, dir, svgName, dataName, isFade, animateTime=1000) {
